...
SOURCES: dict[str, SourceMeta] = {
    ...
    "taiwan_cwa": SourceMeta("taiwan_cwa", "Taiwan CWA climate stations", "Taiwan",
        "Daily station climate observations (rainfall, temperature, humidity, wind, evaporation) via the keyless CODIS archive"),
