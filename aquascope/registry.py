...
SOURCES: dict[str, SourceMeta] = {
    ...
    "greece_hydroscope": _s(
        key="greece_hydroscope", label="Greece Hydroscope", region="Greece",
        description="National hydrological databank: daily river stage (1949-2013), monthly discharge and rainfall",
        agency="Hydroscope consortium (ΥΠΕΝ, ΕΜΥ, ΥΠΑΑΤ)", country="GRC",
        homepage="https://hydroscope.gr/",
    ...
    "greece_openhi": _s(
        ...
        description="Live 15-minute discharge, stage, rainfall, climate and water quality from the ITIA/NTUA network",
        agency="ITIA, National Technical University of Athens", country="GRC",
        homepage="https://openhi.net/",
        variables=("discharge", "water_level", "precipitation", "climate", "water_quality", "evapotranspiration"),
        supports_bbox=True,
        supports_station_lookup=True,
